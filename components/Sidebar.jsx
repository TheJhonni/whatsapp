...
function Sidebar() {
  ...
  const createChat = () => {
    ...
    if (
      ...
      // BUT ONLY IF THE EMAIL IS VALID AND ALREADY EXISTS
      db.collection("chats").add({
        users: [user.email, input], //the email value is our input => create an array pushed into my collection in the db
      });
    }
  };
